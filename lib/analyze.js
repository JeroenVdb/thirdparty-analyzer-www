...
function Analyze(harData, firstPartyProviders, response) {
	...
	logger.log('verbose', 'firstPartyProviders is: ' + firstPartyProviders);
	logger.log('verbose', 'firstPartyProviders typeof is: ' + typeof firstPartyProviders);
	...
	logger.log('verbose', 'First Party urls are: ' + firstPartyProviders.join(', '));
	...
	logger.log('verbose', 'Validated First Party urls are: ' + validatedFirstPartyUrls.join(', '));
...
function validateFirstPartyUrls(url) {
	if (!validUrl.is_web_uri(url)) {
		logger.log('error', 'Invalid first party urls');
	} else {
		return url;
	}
}
